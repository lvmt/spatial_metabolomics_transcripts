...
from dash import Input, Output, dcc, html, callback, dash_table  # dash_table用于显示表格 
...
layout = dbc.Container(
    [
        ...
        dash_table.DataTable(
            iris.to_dict("records"),
            [{'id': c, 'name': c} for c in iris.columns],
            editable=True,
